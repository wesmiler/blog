...
|
*/
$config['base_url'] = 'http://wesmiler.wang/';
...
$config['sess_expire_on_close'] = TRUE; //when close bowser  
$config['sess_encrypt _cookie'] = TRUE; //encrypt the cookie
$config['gc_probability'] = 1; //encrypt the cookie
